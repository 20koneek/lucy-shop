export default {
    'data': [{
        ...
        'priceInCents': 5500,
        'specialInCents': 4125,
    }], 'count': 8, 'total': 13, 'pageCount': 2, 'page': 1,
} as const